...
//In Node.js, __dirname is always the directory in
//which the currently executing script resides

//path.resolve([from], to) returns an absolute path
...
var config = module.exports = {
  ...
  entry: {
    application: [
      //use helper functions to get paths to assets
